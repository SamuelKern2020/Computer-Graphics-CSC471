...
//    string imgName(argv[2]);
    ...
    vector<unsigned int> triBuf; // triangle buffer - an array list
    vector<float> posBuf;   // position buffer - This is our vertices!
    ...
    // Loads the .obj files into the triBuf and posBuf:
